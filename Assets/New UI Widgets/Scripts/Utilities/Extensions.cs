namespace UIWidgets.Extensions
{
	...
	public static class Extensions
	{
		...
		public static bool Filter<TItem>(this ObservableList<TreeNode<TItem>> nodes, Predicate<TreeNode<TItem>> predicate)
		{
			if (nodes == null)
			{
				return false;
			...
			{
				var have_visible_children = node.FilterNodes(predicate);
